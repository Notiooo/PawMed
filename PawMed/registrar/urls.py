...
from .views import PatientBoardView, AddAppointmentView, AddPatientView, PatientView, EditPatientView, ModifyVisitView, InfoVisitView, load_doctors
...
urlpatterns = [
    ...
    path('modify/<int:pk>/', ModifyVisitView.as_view(), name="modify_appointment"),
